...
impl RoutePipeline {
    ...
    /// inside the group's. A static file mount is layered the same way - it answers under
    /// the group's prefix rather than through a route, and carries the same pipeline.
    #[cfg(feature = "middleware")]
