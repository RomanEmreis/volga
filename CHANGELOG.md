...
* `ClientError::Signing` - the signing configuration cannot produce a client assertion: the key failed to load, the key and the algorithm do not match, or the signature could not be computed.
